        ...
        <form action="{{ route("service.update", $service->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleFormControlInput1"  value="{{ $service->name }}">
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <select class="form-control" name="service_type" id="service_type_id">
                        ...
                        <?php 
                        $service_type_dropdown=array('ipd'=>'IPD','opd'=>'OPD');
                        foreach ($service_type_dropdown as $key => $value) {
                            $selected="";
                            if($service->service_type==$key){
                               $selected="selected";
                            }
                ...
                <div class="form-group col-6">
                    ...
                    <select class="form-control" name="service_group" id="service_group_id" >
                        ...
                        <option id="saved_service_group" value="{{ $service->service_group }}" >  {{ $service->service_group }}  </option>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control" name="price" id="exampleFormControlInput4" value="{{ $service->price }}" min="1" max="50000">
                </div>
                
                <div class="form-group col-6">
                    
                    <label for="exampleFormControlSelect4">Note</label>
                    <textarea class="form-control" name="note" id="exampleFormControlTextarea1" rows="3">{{ $service->note }}</textarea>
                </div>
            </div>
            
            <div class="form-footer pt-4 mt-4">
                <button type="submit" class="btn btn-primary btn-default">Edit service</button>
